var ScrollMapsOptionsPanel = new (function _ScrollMapsOptionsPanel(){
    ...
    self.createButton = function(){
        ...
        var div = $('<div id="SCROLLMAP_optionsbutton" style="display: block; height: 20px; position: absolute; bottom: ' + bottom + 'px; right: 0; background: #FFF; z-index: 999999; border: 1px solid #999; box-sizing: border-box;"></div>');
